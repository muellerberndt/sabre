...
const initialize = (apiUrl, apiKey) => {
    return new mythx.Client(undefined, undefined, undefined, apiUrl, apiKey);
};
...
const submitDataForAnalysis = async(client, data, isCheckProperty = false) => {
    return await client.analyze(data, isCheckProperty);
};
